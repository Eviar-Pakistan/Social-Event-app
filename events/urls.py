...
from .views import events_view,create_post,add_comment,like_post,get_comments,submit_qr,post_detail,all_agendas_view

urlpatterns = [
path('',events_view, name='events'),
path('agendas/', all_agendas_view, name='all_agendas'),
